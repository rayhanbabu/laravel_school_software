...
$(document).ready(function(){  
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            var html = '';
                ...
                {
                    if(response.data[count].sub13c==0){ var sub13c=''; }else{
              var sub13c=response.data[count].sub13c; }
   ...
   html += '<td><input type="'+response.sstatus.cstatus+'"  min="0" max="'+response.sstatus.cmark+'" name="sub13c[]"   class="form-control" value="'+sub13c+'"/></td>';
   html += '<input type="hidden"  min="0" max="'+response.sstatus.cmark+'" name="sub14c[]"   class="form-control" value="'+response.data[count].sub14c+'"/>';
