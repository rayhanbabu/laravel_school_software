		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<h5></h5>
				  ...
				  <form method="post" action="{{url('student/login')}}"  class="myform"  enctype="multipart/form-data" >
                         {!! csrf_field() !!}
					  ...
					  <div class="form-group">
		      			<input type="text" class="form-control rounded-left" autocomplete="off"  name="stu_id" placeholder="Student Id " required>
		      		</div>
