...
@section('seatplanindex','active')
@section('content')

<h4 class="mt-4"> SeatPlan  Pdf View  </h4>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">/SeatPlan </li>
                 </ol>
                 ...
                 <div class="row">
                     <div class="col-sm-5">
                       ...
                       <form action="{{ url('pdf/seatplan') }}" method="post" enctype="multipart/form-data">
                          {!! csrf_field() !!}
