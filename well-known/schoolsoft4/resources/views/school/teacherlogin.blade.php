		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<h5></h5>
				  ...
				  <form method="post" action="{{url('teacherlogin')}}"  class="myform"  enctype="multipart/form-data" >
                         {!! csrf_field() !!}
		      		<div class="form-group">
		      			<input type="text" class="form-control rounded-left" autocomplete="off"  name="teacher_userid" placeholder="Teacher ID" required>
		      		</div>
	           
				 <div class="form-group ">
	              <input type="password" class="form-control rounded-left" id="pass"  name="teacher_password" placeholder="Password" required>
