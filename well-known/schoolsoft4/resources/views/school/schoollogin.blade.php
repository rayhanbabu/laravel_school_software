		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<h5></h5>
				  ...
				  <form method="post" action="{{url('schoollogin')}}"  class="myform"  enctype="multipart/form-data" >
                         {!! csrf_field() !!}
		      		<div class="form-group">
		      			<input type="text" class="form-control rounded-left" autocomplete="off"  name="school_phone" placeholder="E-mail/Phone Number" required>
		      		</div>
	           
				 <div class="form-group ">
	              <input type="password" class="form-control rounded-left" id="pass"  name="school_pass" placeholder="Password" required>
	            	...
	            	<div class="w-50">
	            		<label class="checkbox-wrap checkbox-primary">Remember Me
								...
								<div class="w-50 text-md-right">
									<a href="{{url('school/forget')}}">Forgot Password</a>
								</div>
	            </div>
	          </form>
	        </div>
