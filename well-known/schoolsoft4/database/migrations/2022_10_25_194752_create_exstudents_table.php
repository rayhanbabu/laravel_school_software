...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('exstudents', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('sexam')->nullable();
            $table->text('sgp')->nullable();
            $table->text('sg')->nullable();
            $table->text('sroll')->nullable();
            $table->text('sreg')->nullable();
            $table->text('sboard')->nullable();
    ...
    {
        Schema::dropIfExists('exstudents');
    }
};
