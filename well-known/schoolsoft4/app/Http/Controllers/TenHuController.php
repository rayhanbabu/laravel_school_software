...
class TenHuController extends Controller
{
    public function TenHuinput(){
        $school=schoolsession();
        $subject=Subject::where('class','Ten')->where('babu','Humanities')->where('eiin',$school->eiin)->orderBy('subcode','asc')->get();
        return view('TenHu.input',['school'=>$school,'subject'=>$subject]);
    }
 

  /// Subject  View Page
 public function TenHusub($tecode){
  if(Session::has('school')){ 
       ...
       return view('TenHu.'.$name->subcode,['school'=>$school,'subject'=>$subject,'name'=>$name ,'tecodesection'=>$tecodesection]);
      ...
      return view('TenHu.'.$name->subcode,['name'=>$name,'tecodesection'=>$tecodesection]);
        }else{
 ...
 public function TenHuSelect($tecodesection){
  if(Session::has('school')){ 
    $school=schoolsession();
    $examinfo = Examinfo::where('babu','Humanities')->where('class','Ten')->where('eiin',$school->eiin)->first();
...
$student = DB::table('marks')
   ...
   ->where('marks.babu','Humanities')->where('marks.class','Ten')->where('marks.section',substr($tecodesection,10,1))
  ...
  return response()->json([
     ...
     'sstatus'=>$sstatus,
      ...
      public function TenHusub_update(Request $request){
        ...
        $school=teachersession();
         ...
         $markinfo =Markinfo::where('babu','Humanities')->where('class','Ten')->where('eiin',$school->eiin)->get();
     ...
     public function TenHusub_update12(Request $request){
    ...
    public function TenHusub_update14(Request $request){
      ...
      $school=teachersession();
       ...
       public function TenHusub_update16(Request $request){
  ...
  public function TenHusub_update24(Request $request){
     ...
     public function  TenHuresult(Request $request){
         
       $school=schoolsession();
       $subject=Subject::where('class','Ten')->where('babu','Humanities')->where('eiin',$school->eiin)->orderBy('subcode','asc')->get();
       $name=Subject::where('class','Ten')->where('babu','Humanities')->where('eiin',$school->eiin)->first();
       $examinfo = Examinfo::where('babu','Humanities')->where('class','Ten')->where('eiin',$school->eiin)->first();
    
       $mainsubject=Calculation::where('babu','Humanities')->where('class','Ten')->where('eiin',$school->eiin)->first();
       $subcode1=$mainsubject->subcode;  
       $tags=explode(',',$subcode1);

       $student = DB::table('marks')
        ->leftjoin('students','students.id', '=', 'marks.uid')
        ->where('marks.babu','Humanities')->where('marks.class','Ten')->where('marks.section',Session::get('section'))
        ->where('marks.exam',$examinfo->exam)->where('marks.year',$examinfo->year)->where('marks.eiin',$school->eiin)
        ->select('students.name','students.stu_id','students.roll','students.moral','students.main','students.addi','marks.*')
        ->orderBy('students.roll','asc')->get();
         ...
         $student1=$student->first();
          ...
          if($student1){
       return view('TenHu.result',['school'=>$school,'subject'=>$subject ,'name'=>$name,'student'=>$student,'tags'=>$tags,'student1'=>$student1]);
          }else{
   ...
   public function resulttype(Request $request){
     ...
     DB::update("update marks set rs ='$type'  where babu='Humanities' AND class='Ten' AND section='$section'
  ...
  public function TenHuresultupdate(Request $request){

      $school=School::where('eiin',Session::get('school')->eiin)->first();
    $examinfo=Examinfo::where('babu','Humanities')->where('class','Ten')->where('eiin',$school->eiin)->first();
    $section=Session::get('section');

    $max=DB::table('marks')->where('babu','Humanities')->where('class','Ten')->where('section',Session::get('section'))
    ...
    ,DB::raw("Max(sub23t) as sub23h"),DB::raw("Max(sub24t) as sub24h"))->first();
     ...
     $markinfo=Markinfo::where('babu','Humanities')->where('class','Ten')->where('eiin',Session::get('school')->eiin)->get();
     $mainsubject=Calculation::where('babu','Humanities')->where('class','Ten')->where('eiin',$school->eiin)->first();
     $subcode1=$mainsubject->subcode;  
     $tags=explode(',',$subcode1);
