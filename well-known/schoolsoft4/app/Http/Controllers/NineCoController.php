...
class NineCoController extends Controller
{
    public function NinCoinput(){
        $school=schoolsession();
        $subject=Subject::where('class','Nine')->where('babu','Commerce')->where('eiin',$school->eiin)->orderBy('subcode','asc')->get();
        return view('NinCo.input',['school'=>$school,'subject'=>$subject]);
    }
 

  /// Subject  View Page
 public function NinCosub($tecode){
  if(Session::has('school')){ 
       ...
       return view('NinCo.'.$name->subcode,['school'=>$school,'subject'=>$subject,'name'=>$name ,'tecodesection'=>$tecodesection]);
    ...
    if(!empty(teacher_access($tecode,$subjectauth))){ 
      ...
      return view('NinCo.'.$name->subcode,['name'=>$name,'tecodesection'=>$tecodesection]);
        }else{
     ...
     public function NinCoSelect($tecodesection){
      if(Session::has('school')){ 
        $school=schoolsession();
        $examinfo = Examinfo::where('babu','Commerce')->where('class','Nine')->where('eiin',$school->eiin)->first();
    ...
    $student = DB::table('marks')
       ...
       ->where('marks.babu','Commerce')->where('marks.class','Nine')->where('marks.section',substr($tecodesection,10,1))
   ...
   public function NinCosub_update(Request $request){
     ...
     $markinfo =Markinfo::where('babu','Commerce')->where('class','Nine')->where('eiin',$school->eiin)->get();
   ...
   public function NinCosub_update12(Request $request){
   ...
   public function NinCosub_update14(Request $request){
      ...
      public function NinCosub_update16(Request $request){
      ...
      $school=teachersession();
        ...
        public function NinCosub_update24(Request $request){
 ...
 public function NinCoresult(Request $request){
         
       $school=schoolsession();
       $subject=Subject::where('class','Nine')->where('babu','Commerce')->where('eiin',$school->eiin)->orderBy('subcode','asc')->get();
       $name=Subject::where('class','Nine')->where('babu','Commerce')->where('eiin',$school->eiin)->first();
       $examinfo = Examinfo::where('babu','Commerce')->where('class','Nine')->where('eiin',$school->eiin)->first();
    
       $mainsubject=Calculation::where('babu','Commerce')->where('class','Nine')->where('eiin',$school->eiin)->first();
       $subcode1=$mainsubject->subcode;  
       $tags=explode(',',$subcode1);

       $student = DB::table('marks')
        ->leftjoin('students', 'students.id', '=', 'marks.uid')
        ->where('marks.babu','Commerce')->where('marks.class','Nine')->where('marks.section',Session::get('section'))
        ->where('marks.exam',$examinfo->exam)->where('marks.year',$examinfo->year)->where('marks.eiin',$school->eiin)
        ->select('students.name','students.stu_id','students.roll','students.moral','students.main','students.addi','marks.*')
     ...
     $student1=$student->first();
          ...
          if($student1){
     return view('NinCo.result',['school'=>$school,'subject'=>$subject ,'name'=>$name,'student'=>$student,'tags'=>$tags,'student1'=>$student1]);
           }else{
         return redirect("/NinCoinput")->with('status','This section No Students');
        }
 }
  ...
  public function resulttype(Request $request){
      ...
      DB::update("update marks set rs ='$type'  where babu='Commerce' AND class='Nine' AND section='$section'
  ...
  public function NinCoresultupdate(Request $request){

      $school=School::where('eiin',Session::get('school')->eiin)->first();
    $examinfo=Examinfo::where('babu','Commerce')->where('class','Nine')->where('eiin',$school->eiin)->first();
    $section=Session::get('section');

    $max=DB::table('marks')->where('babu','Commerce')->where('class','Nine')->where('section',Session::get('section'))
    ...
    ,DB::raw("Max(sub23t) as sub23h"),DB::raw("Max(sub24t) as sub24h"))->first();
     ...
     $markinfo=Markinfo::where('babu','Commerce')->where('class','Nine')->where('eiin',Session::get('school')->eiin)->get();
     $mainsubject=Calculation::where('babu','Commerce')->where('class','Nine')->where('eiin',$school->eiin)->first();
     $subcode1=$mainsubject->subcode;  
     $tags=explode(',',$subcode1);
