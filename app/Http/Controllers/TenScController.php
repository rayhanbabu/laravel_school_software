...
class TenScController extends Controller
{
    public function TenScinput(){
        $school=schoolsession();
        $subject=Subject::where('class','Ten')->where('babu','Science')->where('eiin',$school->eiin)->orderBy('subcode','asc')->get();
        return view('TenSc.input',['school'=>$school,'subject'=>$subject]);
    }
 
  /// Subject  View Page
  public function TenScsub($tecode){
    ...
    return view('TenSc.'.$name->subcode,['school'=>$school,'subject'=>$subject,'name'=>$name ,'tecodesection'=>$tecodesection]);
      ...
      if(!empty(teacher_access($tecode,$subjectauth))){ 
         $name=Subject::where('tecode',substr($tecode,0,10))->where('eiin',teachersession()->eiin)->first();
          ...
          return view('TenSc.'.$name->subcode,['name'=>$name,'tecodesection'=>$tecodesection]);
        }else{
   ...
   public function TenScSelect($tecodesection){
      if(Session::has('school')){ 
         $school=schoolsession();
         $examinfo = Examinfo::where('babu','Science')->where('class','Ten')->where('eiin',$school->eiin)->first();
     ...
     $student = DB::table('marks')
        ...
        ->where('marks.babu','Science')->where('marks.class','Ten')->where('marks.section',substr($tecodesection,10,1))
   ...
   public function TenScsub_update(Request $request){
      ...
      $markinfo =Markinfo::where('babu','Science')->where('class','Ten')->where('eiin',$school->eiin)->get();
  ...
  public function TenScsub_update12(Request $request){
 ...
 public function TenScsub_update14(Request $request){
   ...
   if(Session::has('school')){ 
    ...
    public function TenScsub_update16(Request $request){
 ...
 public function TenScsub_update24(Request $request){
   ...
   public function TenScresult(Request $request){
         
       $school=schoolsession();
       $subject=Subject::where('class','Ten')->where('babu','Science')->where('eiin',$school->eiin)->orderBy('subcode','asc')->get();
       $name=Subject::where('class','Ten')->where('babu','Science')->where('eiin',$school->eiin)->first();
       $examinfo = Examinfo::where('babu','Science')->where('class','Ten')->where('eiin',$school->eiin)->first();
    
       $mainsubject=Calculation::where('babu','Science')->where('class','Ten')->where('eiin',$school->eiin)->first();
       $subcode1=$mainsubject->subcode;  
       $tags=explode(',',$subcode1);

        $student = DB::table('marks')
        ->leftjoin('students','students.id', '=', 'marks.uid')
        ->where('marks.babu','Science')->where('marks.class','Ten')->where('marks.section',Session::get('section'))
        ->where('marks.exam',$examinfo->exam)->where('marks.year',$examinfo->year)->where('marks.eiin',$school->eiin)
        ->select('students.name','students.stu_id','students.roll','students.moral','students.main','students.addi','marks.*')
        ->orderBy('students.roll','asc')->get();
         ...
         $student1=$student->first();
          if($student1){
        return view('TenSc.result',['school'=>$school,'subject'=>$subject ,'name'=>$name,'student'=>$student,'tags'=>$tags,'student1'=>$student1]);
          }else{
   ...
   public function resulttype(Request $request){
      ...
      DB::update("update marks set rs ='$type'  where babu='Science' AND class='Ten' AND section='$section'
 ...
 public function TenScresultupdate(Request $request){

    $school=School::where('eiin',Session::get('school')->eiin)->first();
    $examinfo=Examinfo::where('babu','Science')->where('class','Ten')->where('eiin',$school->eiin)->first();
    $section=Session::get('section');

     $max=DB::table('marks')->where('babu','Science')->where('class','Ten')->where('section',Session::get('section'))
     ...
     $markinfo=Markinfo::where('babu','Science')->where('class','Ten')->where('eiin',Session::get('school')->eiin)->get();
     $mainsubject=Calculation::where('babu','Science')->where('class','Ten')->where('eiin',$school->eiin)->first();
     $subcode1=$mainsubject->subcode;  
     $tags=explode(',',$subcode1);
