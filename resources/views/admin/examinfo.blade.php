...
<div class="row mt-3 mb-0 mx-2">
               <div class="col-6"> <h4 class="mt-0">Examination Infomation </h4></div>
                     <div class="col-3">
      ...
      <form  method="POST" id="add_employee_form" enctype="multipart/form-data">
        ...
        <div class="modal-body p-4 bg-light">
          <div class="row">
            ...
            <div class="col-lg-6 my-2">
              <label for="lname">Year  <span style="color:red;"> * </span></label>
            ...
            <div class="col-lg-6 my-2">
              <label for="lname">Examination  <span style="color:red;"> * </span></label>
         ...
         <div class="modal-body p-4 bg-light">
          <div class="row">
           ...
           <div class="col-lg-6 my-2">
            ...
            <div class="col-lg-6 my-2">
              <label for="lname">Examination  <span style="color:red;"> * </span></label>
                <select class="form-select" name="exam" id="edit_exam"  aria-label="Default select example" required>
                                  <option value="">Select</option>
                                   @foreach($exam as $row)
                                  <option value="{{$row->serial}}">{{$row->text2}}</option>
                                   @endforeach
      ...
      function fetchAll() {
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            $("#edit_exam").val(response.data.exam);
