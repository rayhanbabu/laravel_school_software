               ...
               <div class="col-3"> <h4 class="mt-0"> Color View</h4></div>
                     <div class="col-2">
                       <div class="d-grid gap-2 d-md-flex justify-content-md-end "> 
                          <form method="post" action="{{url('admin/colorimport')}}"  class="myform"  enctype="multipart/form-data" >
                             {!! csrf_field() !!}
 ...
 <div class="table-responsive">
  <table class="table table-bordered" id="employee_data">
	...
	@foreach($color as $row)
     ...
     <td><a  class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete  this row?')"  href="{{ url('admin/colordelete/'.$row->id)}}">Delete</a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Color Add</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>

      <div class="modal-body">

      <form method="post" action="{{url('admin/colorinsert')}}"  class="myform"  enctype="multipart/form-data" >
   {!! csrf_field() !!}
   ...
   <div class="row px-3">
         ...
         <div class="form-group col-sm-4  my-2">
               <input type="number" name="color1" id="color1" class="form-control" required>
          </div>
          <div class="form-group col-sm-4  my-2">
               <input type="number" name="color2" id="color2"   class="form-control" required>
          </div> 

          <div class="form-group col-sm-4  my-2">
              
              <input type="number" name="color21" id="color21"  class="form-control" required>
         </div>

          <label class=""><b>SeatPlan Text Color Ex. <span style="color:red;">41, 41, 61 </span></b></label>
          <div class="form-group col-sm-4  my-2">
             
               <input type="number" name="color3" id="color3"  class="form-control" required>
          </div> 
          <div class="form-group col-sm-4  my-2">
              
               <input type="number" name="color4" id="color4"  class="form-control" required>
          </div>

          <div class="form-group col-sm-4  my-2">
              
               <input type="number" name="color22" id="color22"  class="form-control" required>
          </div>
          ...
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Marks Input Form Text Color<span style="color:red;">  #0d0d0d  </span></b></label>
               <input type="text" name="color5" class="form-control" required>
          </div> 
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Marks Input Form Border Color<span style="color:red;"> #706666 </span></b></label>
               <input type="text" name="color6" class="form-control" required>
          </div> 


          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Markseet Text Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color7" class="form-control" required>
          </div> 
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Markseet Border Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color8" class="form-control" required>
          </div> 


          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Tabulationsheet Text Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color9" class="form-control" required>
          </div> 
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Tabulationsheet Border Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color10" class="form-control" required>
          </div> 


          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Summary Text Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color11" class="form-control" required>
          </div> 
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Summary Border Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color12" class="form-control" required>
          </div> 


          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Testimonial Text Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color13" class="form-control" required>
          </div> 
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Testimonial Border Color<span style="color:red;"> * </span></b></label>
               <input type="text" name="color14" class="form-control" required>
          </div> 
 ...
 <div class="modal fade" id="editmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="{{url('admin/colorupdate')}}"  class="myform"  enctype="multipart/form-data" >
   {!! csrf_field() !!}
   ...
   <div class="row px-3">
         ...
         <div class="form-group col-sm-4  my-2">
          ...
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Markseet Text Color Ex.<span style="color:red;">  </span></b></label>
               <input type="text" name="color7" id="edit_color7"  class="form-control" required>
          </div> 
          <div class="form-group col-sm-6  my-2">
               <label class=""><b>Markseet Border Color Ex.<span style="color:red;">  </span></b></label>
