...
$(document).ready(function(){  
          ...
          success: function(response) {
            ...
            var html = '';
                for(var count = 0; count < response.data.length; count++)
                {
                 ...
                 if(response.data[count].sub14c==0){ var sub14c=''; }else{
              var sub14c=response.data[count].sub14c; }
   ...
   html += '<td><input type="'+response.sstatus.cstatus+'"  min="0" max="'+response.sstatus.cmark+'" name="sub14c[]"   class="form-control" value="'+sub14c+'"/></td>';
   html += '<input type="hidden"  min="0" max="'+response.sstatus.cmark+'" name="sub13c[]"   class="form-control" value="'+response.data[count].sub13c+'"/>';
