...
$(document).ready(function(){  
          ...
          success: function(response) {
            ...
            var html = '';
                for(var count = 0; count < response.data.length; count++)
                {
                   ...
                   if(response.data[count].sub12c==0){ var sub12c=''; }else{
              var sub12c=response.data[count].sub12c; }

                   if(response.data[count].sub12m==0){ var sub12m=''; }else{
             var sub12m=response.data[count].sub12m; } 
   ...
   html += '<td><input type="'+response.sstatus.cstatus+'"  min="0" max="'+response.sstatus.cmark+'" name="sub12c[]"   class="form-control" value="'+sub12c+'"/></td>';
   html += '<td><input type="'+response.sstatus.mstatus+'"  min="0" max="'+response.sstatus.mmark+'" name="sub12m[]"   class="form-control" value="'+sub12m+'" /></td>';
   
   html += '<input type="hidden"  min="0" max="'+response.sstatus.pmark+'" name="sub11c[]"   class="form-control" value="'+response.data[count].sub11c+'" />';
   html += '<input type="hidden"  min="0" max="'+response.sstatus.pmark+'" name="sub11m[]"   class="form-control" value="'+response.data[count].sub11m+'" />';
