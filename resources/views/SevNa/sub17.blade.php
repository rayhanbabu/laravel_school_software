...
$(document).ready(function(){  
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            var html = '';
                ...
                {
                    if(response.data[count].sub17c==0){ var subc=''; }else{
              var subc=response.data[count].sub17c; }

                    if(response.data[count].sub17m==0){ var subm=''; }else{
             var subm=response.data[count].sub17m; } 
                    
                    if(response.data[count].sub17p==0){ var subp=''; }else{
              var subp=response.data[count].sub17p; }
   ...
   html += '<td>'+Math.ceil(response.data[count].sub17c * 0.7)+'</td>';
   html += '<td>'+response.data[count].sub17t+'</td>';
   html += '<td>'+response.data[count].sub17gp+'</td>';
   html += '<td>'+response.data[count].sub17g+'</td>';
   html += '</tr>';
