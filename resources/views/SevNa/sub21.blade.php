...
$(document).ready(function(){  
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            var html = '';
                ...
                {
                    if(response.data[count].sub21c==0){ var subc=''; }else{
              var subc=response.data[count].sub21c; }

                    if(response.data[count].sub21m==0){ var subm=''; }else{
             var subm=response.data[count].sub21m; } 
                    
                    if(response.data[count].sub21p==0){ var subp=''; }else{
              var subp=response.data[count].sub21p; }
   ...
   html += '<td>'+Math.ceil(response.data[count].sub21c * 0.7)+'</td>';
   html += '<td>'+response.data[count].sub21t+'</td>';
   html += '<td>'+response.data[count].sub21gp+'</td>';
   html += '<td>'+response.data[count].sub21g+'</td>';
   html += '</tr>';
